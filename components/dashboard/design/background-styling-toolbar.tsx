           ...
           <div className="flex items-center gap-2 px-2 py-2 rounded-md border border-gray-200 bg-gray-50/50">
              <ColorCircle
                 ...
                 onChange={(c) => {
                    ...
                    // Also update text color for contrast if needed, handled by parent usually but good to keep in mind
                 }}
                 size="md"
               />
                   ...
                   <div className="relative w-full h-24 rounded-lg overflow-hidden border border-gray-200 group">
                       ...
                       <div className="absolute inset-0 bg-black/0 group-hover:bg-black/40 transition-colors flex items-center justify-center opacity-0 group-hover:opacity-100">
                           <button
                              ...
                              className="bg-white text-red-500 px-3 py-1.5 rounded-full text-xs font-bold flex items-center gap-1 hover:bg-red-50"
                           >
