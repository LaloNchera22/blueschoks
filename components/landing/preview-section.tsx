...
export function PreviewSection() {
  return (
    <section className="px-4 pb-24 w-full max-w-lg mx-auto">
      <div className="rounded-2xl border border-white/10 bg-surface-dark/50 p-2 overflow-hidden shadow-2xl relative">
        <div className="aspect-[4/3] rounded-xl bg-slate-800 relative overflow-hidden group">
            ...
            <div className="absolute bottom-4 left-4 right-4">
                ...
                <h3 className="text-white font-bold text-lg">Gestiona pedidos desde cualquier lugar</h3>
            </div>
        </div>
      </div>
    </section>
