...
export function Hero() {
  return (
    <section className="w-full flex flex-col items-center justify-center px-4 text-center py-20">
      <div className="flex flex-col items-center w-full max-w-4xl mx-auto">
        ...
        {/* Título Principal */}
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-black tracking-tighter text-[#0F172A] mb-6 leading-[1.1]">
          Tu Tienda Online <br />
          En 30 Segundos.
        </h1>

        {/* Subtítulo */}
        <p className="text-lg text-slate-500 max-w-xl mb-10 leading-relaxed mx-auto font-medium">
