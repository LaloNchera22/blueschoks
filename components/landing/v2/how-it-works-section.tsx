  ...
  return (
    <section className="px-4 py-16 w-full">
        <div className="flex flex-col gap-2 mb-10 text-center">
            <h2 className="text-2xl font-bold text-white font-display">Cómo funciona</h2>
        ...
        <div className="flex flex-col gap-6 relative max-w-lg mx-auto">
            ...
            <div className="relative z-10 flex gap-5 items-start group">
                <div className="relative flex-shrink-0">
                    ...
                    <div className="relative flex items-center justify-center size-14 rounded-full bg-surface-dark border border-primary/30 shadow-[0_0_10px_rgba(13,89,242,0.1)]">
                        <Package className="text-primary w-7 h-7" />
                    </div>
                </div>
                <div className="pt-2">
                    <h3 className="text-lg font-bold text-white mb-1 font-display">Crea</h3>
            ...
            <div className="relative z-10 flex gap-5 items-start group">
                ...
                <div className="pt-2">
                    <h3 className="text-lg font-bold text-white mb-1 font-display">Comparte</h3>
            ...
            <div className="relative z-10 flex gap-5 items-start group">
                ...
                <div className="pt-2">
                    <h3 className="text-lg font-bold text-white mb-1 font-display">Vende</h3>
